...
// replace trainingBranding
namespace oat\trainingBranding\scripts\install;

use oat\oatbox\extension\InstallAction;
use oat\trainingBranding\model\theme\PlatformDefault;// provided your theme class has that name
